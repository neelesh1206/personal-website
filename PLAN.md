...
| Coding Prep       | `/admin/coding-prep`     | ✅     | Personal interview-prep tracker — 10-day plan with persistent checklist + per-day autosave notes, 75-Q reference library with client-side search. Shared admin layout with tab nav. Neon-backed (prep_progress, prep_notes). |
